...
public class CountryResourceIntTest {
    ...
    private static final Region DEFAULT_REGION = Region.AMERICA;
    private static final Region UPDATED_REGION = Region.ASIA;
    ...
    public void setup() {
        ...
        CountryResource countryResource = new CountryResource(countryService, countryValidator);
